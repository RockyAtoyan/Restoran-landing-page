...
"use strict";const header=document.querySelector("header");function Head(){var e=document.querySelector(".intro");window.scrollY>e.clientHeight-200?header.classList.add("active"):header.classList.remove("active")}document.addEventListener("scroll",Head);const main=document.documentElement;function showMenu(e){var s=document.querySelector(".burger"),t=document.querySelector(".menu"),i=document.querySelector("body");e.target.closest(".burger")&&(s.classList.toggle("active"),t.classList.toggle("active"),i.classList.toggle("active")),e.target.closest(".header_menu")||(s.classList.remove("active"),t.classList.remove("active"),i.classList.remove("active"))}if(main.addEventListener("click",showMenu),main.clientWidth<=320){const f=document.querySelector(".intro_link");f.innerHTML="МЕНЮ"}const slider=new Swiper(".reviews_carousel",{speed:1e3,loop:!0,slidesPerView:1,effect:"cube",init:!1,on:{slideChange:()=>{sliderDots.forEach(e=>e.classList.remove("active")),sliderDots[slider.realIndex].classList.add("active")}}}),sliderNav=document.querySelectorAll(".reviews_inner > button"),sliderDots=(sliderNav[1].addEventListener("click",()=>slider.slidePrev()),sliderNav[0].addEventListener("click",()=>slider.slideNext()),document.querySelectorAll(".reviews_icon"));console.log(sliderDots[slider.realIndex]),sliderDots[slider.realIndex].classList.add("active"),sliderDots.forEach((e,s)=>{e.addEventListener("click",()=>{slider.slideTo(s)})}),slider.init();